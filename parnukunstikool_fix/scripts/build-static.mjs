...
const SUPABASE_URL = 'https://bmmflgbdiudhufdesxos.supabase.co';
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJtbWZsZ2JkaXVkaHVmZGVzeG9zIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzk3MTgzOTIsImV4cCI6MjA5NTI5NDM5Mn0.7jdqPuBk3jWVHXx3pR1mtBf5RH1rBRdWPANAFlZUdt8';
const supabase = createClient(SUPABASE_URL, SUPABASE_KEY);

const OUT = '/tmp/static-site';
...
const [{ data: categories }, { data: artworks }, { data: pages }, { data: lessons }] = await Promise.all([
...
for (const a of artworks) {
  if (imgMap.has(a.image_path)) continue;
...
for (const c of categories) {
  ...
  const body = `<div class="wrap"><a class="back" href="../index.html">← Tagasi</a>
    ...
    <div class="artworks">${items.map(a => `<article>
      <img src="../${imgSrc(a.image_path)}" alt="${esc(a.title || a.author_name)}" loading="lazy">
